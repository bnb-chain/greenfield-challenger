module github.com/gnfd-challenger

go 1.19

require (
	github.com/bnb-chain/greenfield-go-sdk v0.0.3
	github.com/bnb-chain/greenfield-relayer v0.0.2
...
replace (
	github.com/cosmos/cosmos-sdk => github.com/bnb-chain/greenfield-cosmos-sdk v0.0.6
	...
	github.com/tendermint/tendermint => github.com/bnb-chain/greenfield-tendermint v0.0.1
)
